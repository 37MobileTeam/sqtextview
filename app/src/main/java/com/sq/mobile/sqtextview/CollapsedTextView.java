...
public class CollapsedTextView extends AppCompatTextView implements View.OnClickListener {
    ...
    private class ExpandedClickableSpan extends ClickableSpan {
        ...
        public void onClick(View widget) {
            ...
            if (mTipsClickable) {
                ...
                if (mJumpClickableSpanListener != null) {
                    mJumpClickableSpanListener.onClick(widget);
                }
            }
        }
    ...
    private OnClickListener mJumpClickableSpanListener;

    public void setJumpClickableSpanListener(OnClickListener l) {
        this.mJumpClickableSpanListener = l;
    }
}
